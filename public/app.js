    ...
    <aside class="sidebar">
      ...
      <nav>
        ...
        <div class="support-nav-group ${currentRoutePath().startsWith('/support/') || currentRoutePath() === '/help' ? 'open' : ''}">
          <button class="nav support-nav-toggle ${currentRoutePath().startsWith('/support/') || currentRoutePath() === '/help' ? 'active' : ''}" type="button" aria-expanded="${currentRoutePath().startsWith('/support/') || currentRoutePath() === '/help' ? 'true' : 'false'}"><span class="nav-icon">☸</span><span class="nav-label">帮助中心</span><span class="support-nav-chevron">⌄</span></button>
